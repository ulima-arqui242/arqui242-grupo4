...
Para implementar **CloudFront** en Amazon, este procedimiento se hizo con anterioridad para el patrón cloud **Static Content Hosting**. Más detalles aquí: [¡Ver detalles!](#cliente-frontend-react-js)
