...
| Encargado | Respresenta del sistema | Administrar las solicitudes de los usuarios | Compronnder como la arquitectura soporta la gestion de solicitudes de distintos usuarios y tipos |
...
| **Stakeholder** | **Rol** | **Responsabilidad** | **Interés en la arquitectura** |
| --- | --- | --- | --- |
| Encargado | Representante del sistema | Administrar el presupuesto dado para el mes | Comprender como la arquitectura soporta la gestion de capital mediante integracion con dashboards dinamicos |
| Administrador de base de datos (DBA) | Admnistrador de BD | Gestionar el almacenamiento y actualizacion de capital a cada area | Garantizar que la manipulacion de datos sea segura y rapida |
...
| Mantenimiento | Mantenimiento | Gestionar la actualizacion de porcentaje para que funcionen de manera adecuada | Asegurar el correco funcionamiento para los encargados |
...
| Administrador de base de datos (DBA) | Administrador de BD | Gestionar el almacenamiento de los chat de la junta | Garantizar que la manipulacion de datos sea rapida,segura y confiable | 
