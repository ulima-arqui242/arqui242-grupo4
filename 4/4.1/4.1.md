...
- **Costo de implementación:** Se prioriza una solución que no implique gastos adicionales.
- **Simplicidad de técnica:** Es importante que la técnica elegida sea fácil de implementar y mantener.
- **Impacto en la experiencia del usuario:** Se busca minimizar la molestia para los usuarios durante fallos temporales.
- **Tiempo de recuperación:** La táctica debe permitir que el sistema se recupere rápidamente de fallos.
